      ...
      <div class="navbar-content">
        <ul class="pc-navbar">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="https://html.phoenixcoded.net/light-able/bootstrap/dashboard/index.html">Analytics</a></li>
              <li class="pc-item"><a class="pc-link" href="https://html.phoenixcoded.net/light-able/bootstrap/dashboard/affiliate-dashboard.html">Affiliate</a></li>
              <li class="pc-item"><a class="pc-link" href="https://html.phoenixcoded.net/light-able/bootstrap/dashboard/finance.html">Finance</a></li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link"
            ...
            ></a>
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="{{route('panel.datos.create')}}">Data Register </a></li>
              <li class="pc-item"><a class="pc-link" href="{{route('panel.experiences.create')}}">Experience</a></li>
              <li class="pc-item"><a class="pc-link" href="{{route('panel.certificates.create')}}">Certificates</a></li>
            </ul>
          </li>
...
@else
  <div class="row" style="padding:50px;" >
    <a class="btn btn-warning" href="{{route('login')}}" style="width: 20%;text-align:center;">Login</a>
  </div>
  @endauth
@endif
